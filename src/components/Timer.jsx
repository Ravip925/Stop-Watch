...
const Heading = styled.h1`
  ...
  font-size: 50px;
  color: #0b0bc6;
  text-shadow: 0px 0px 0 rgb(224, 224, 224), 1px 1px 0 rgb(213, 213, 213),
    2px 2px 0 rgb(202, 202, 202), 3px 3px 0 rgb(191, 191, 191),
    4px 4px 0 rgb(180, 180, 180), 5px 5px 0 rgb(169, 169, 169),
